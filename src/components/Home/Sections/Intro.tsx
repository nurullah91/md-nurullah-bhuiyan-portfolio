...
export default function Intro() {
  return (
    <section id="intro" className="introBG py-24 lg:px-10">
      <div
        className=" lg:w-9/12 w-11/12 mx-auto flex flex-col-reverse
   lg:flex-row"
      >
        <div>
          ...
          <p className="text-white my-4">
            ...
            modern web applications. I specialize in building intuitive user
            interfaces and scalable backend systems to deliver seamless
            experiences.
          </p>
